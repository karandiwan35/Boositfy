            ...
            <div className="hidden sm:mb-8 sm:flex sm:justify-left">
              <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                ...
                <a href="#" className="font-semibold text-orange-600">
                  ...
                  Let's Do It <span aria-hidden="true">&rarr;</span>
                </a>
              </div>
            </div>
            <div className="text-left">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                We take your brand to newer pinnacles
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Elevate your brand's digital presence with Boostify: Expert
                strategies, unparalleled results, and limitless growth
                opportunities await your business now!
              </p>
