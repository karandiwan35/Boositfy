...
const Testimonial = () => {
  ...
  return (
    <>
      <section className="pb-8 pt-8 dark:bg-dark lg:pb-[120px] lg:pt-[120px]">
          ...
          <Swiper slidesPerView={1} ref={sliderRef}>
            <SwiperSlide>
              <SingleTestimonial
                ...
                reviewAlt="lineicon"
                details="I've had the pleasure of working with Boostify for several months now, and I couldn't be happier with the results. From the initial consultation to the ongoing support, their dedication to delivering results is unmatched. They took the time to understand our unique challenges"
                name="Jason Smith"
            ...
            <SwiperSlide>
              <SingleTestimonial
                ...
                reviewImg="https://cdn.tailgrids.com/2.0/image/marketing/images/testimonials/testimonial-01/lineicon.svg"
                reviewAlt="lineicon"
                details="Boostify has truly transformed our digital presence! As a small business owner, I was overwhelmed with trying to navigate the complexities of online marketing. Thankfully, Boostify stepped in and provided tailored strategies that aligned perfectly with our goals."
                name="Larry Diamond"
